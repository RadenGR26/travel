            ...
            <form action="" method="post" enctype="multipart/form-data">
             <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="tiket" name="tiket" value="<?php echo $tiket ?>" required="tiket" onkeyup="sum();">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <input class="form-control" type="file" name="lunas">
              </div>
              <div class="form-group">
                <label for="tanggal_in">Mulai Tanggal :</label>
                <input type="text" class="form-control" id="tanggal_in" placeholder="Enter Mulai Tanggal" name="tanggal_in" required="tanggal_in" value="<?php echo $tanggal_in ?>">
              </div>
              <div class="form-group">
                <label for="tanggal_out">Selesai Tanggal :</label>
                <input type="text" class="form-control" id="tanggal_out" placeholder="Enter Selesai Tanggal" name="tanggal_out" required="tanggal_out" value="<?php echo $tanggal_out ?>">
              </div>
              <div class="form-group">
                <label>Status :</label>
