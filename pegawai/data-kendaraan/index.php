        ...
        <li class="nav-item">
          ...
          <li class="nav-item active">
            ...
            <div id="collapseSix" class="collapse" aria-labelledby="headingOnne" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Pilihan :</h6>
                <a class="collapse-item active" href="../data-kendaraan/index.php">Input Data</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 class="h3 mb-0 text-gray-800"><strong>INPUT DATA KENDARAAN</strong></h1>
            </div>
            <form action="" method="post" enctype="multipart/form-data">
              <div class="form-group">
                <label for="nama_kendaraan">Nama Kendaraan :</label>
                <input type="text" class="form-control" id="nama_kendaraan" placeholder="Enter Nama Kendaraan" name="nama_kendaraan" required="nama_kendaraan">
              </div>
              <div class="form-group">
                <label for="gambar_kendaraan">Foto Kendaraan :</label>
                <input type="file" class="form-control" id="gambar_kendaraan" placeholder="Enter Foto Kendaraan" name="gambar_kendaraan" required="gambar_kendaraan" >
...
if(isset($_POST['insert'])){
  ...
  $namaSementara = $_FILES['gambar_kendaraan']['tmp_name'];

    // tentukan lokasi gambar_kendaraan akan dipindahkan
  $dirUpload = "../../file_upload/";

    // pindahkan gambar_kendaraan
  $terupload = move_uploaded_file($namaSementara, $dirUpload.$gambar_kendaraan);

  $idakun = $_POST['idakun'];

    // Insert user data into table
  $result = mysqli_query($conn, "INSERT INTO kendaraan(nama_kendaraan,gambar_kendaraan) VALUES('$nama_kendaraan','".$gambar_kendaraan."')");
