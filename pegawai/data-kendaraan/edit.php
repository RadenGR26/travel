        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 class="h3 mb-0 text-gray-800"><strong>EDIT DATA KENDARAAN</strong></h1>
            </div>

            <form action="" method="post" enctype="multipart/form-data">
              <div class="form-group">
                <label for="nama_kendaraan">nama_kendaraan :</label>
                <input type="text" class="form-control" id="nama_kendaraan" placeholder="Enter nama_kendaraan" name="nama_kendaraan" required="nama_kendaraan" value="<?php echo $nama_kendaraan ?>">
              </div>

              <div class="form-group">
                <label>Foto Kendaraan :</label><br>
                <a href="../../file_upload/<?php echo $gambar_kendaraan?>"><img src="../../file_upload/<?php echo $gambar_kendaraan?>" width="300px"></a><br><br>
                <input class="form-control" type="file" name="gambar_kendaraan">
              </div>
...
{   
  ...
  if(file_exists($_FILES['gambar_kendaraan']['tmp_name'])){
    $gambar_kendaraan = date("YmdHis").$_FILES['gambar_kendaraan']['name'];
    $namaid_cardSementara = $_FILES['gambar_kendaraan']['tmp_name'];
    $dirUpload = "../../file_upload/";
    $terupload = move_uploaded_file($namaid_cardSementara, $dirUpload.$gambar_kendaraan);
    mysqli_query($conn, "UPDATE kendaraan SET gambar_kendaraan='$gambar_kendaraan' WHERE id=$id");
  }

  mysqli_query($conn, "UPDATE kendaraan SET nama_kendaraan='$nama_kendaraan',gambar_kendaraan='$gambar_kendaraan' WHERE id=$id");
