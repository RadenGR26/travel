...
<body id="page-top">
  ...
  <div id="wrapper">
        ...
        <li class="nav-item">
          ...
          <li class="nav-item active">
            ...
            <div id="collapseThree" class="collapse" aria-labelledby="headingOnne" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Pilihan :</h6>
                <a class="collapse-item active" href="../data-paket/index.php">Input Data</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 class="h3 mb-0 text-gray-800"><strong>INPUT DATA PAKET</strong></h1>
            </div>
            <form action="" method="post" enctype="multipart/form-data">
              <div class="form-group">
                <label for="nama_paket">Nama Paket :</label>
                <input type="text" class="form-control" id="nama_paket" placeholder="Enter Nama Paket" name="nama_paket" required="nama_paket">
              </div>
              <?php
   ...
   <div class="form-group">
      ...
      <textarea type="text" class="form-control" id="keterangan" name="keterangan" required="keterangan"></textarea>
    </div>
    <div class="form-group">
      <label for="harga">Harga :</label>
      <input type="number" class="form-control" id="harga" name="harga" required="harga">
    </div>
...
if(isset($_POST['insert'])){
  ...
  $result = mysqli_query($conn, "INSERT INTO paket(nama_paket,nama_wisata1,gambar_wisata1,nama_wisata2,gambar_wisata2,nama_hotel,gambar_hotel,nama_restoran,gambar_restoran,nama_kendaraan,gambar_kendaraan,keterangan,harga) VALUES('$nama_paket','$nama_wisata1','$gambar_wisata1','$nama_wisata2','$gambar_wisata2','$nama_hotel','$gambar_hotel','$nama_restoran','$gambar_restoran','$nama_kendaraan','$gambar_kendaraan','$keterangan','$harga')");
