        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 class="h3 mb-0 text-gray-800"><strong>EDIT DATA PAKET</strong></h1>
            </div>

            <form action="" method="post" enctype="multipart/form-data">
             <div class="form-group">
              <label for="nama_paket">Nama Paket :</label>
              <input type="text" class="form-control" id="nama_paket" placeholder="Enter Nama Paket" name="nama_paket" required="nama_paket" value="<?php echo $nama_paket ?>">
            </div>
            <?php
            ...
            <div class="form-group">
              ...
              <select class="form-control" id="nama_wisata1" name="nama_wisata1" required="nama_wisata1">
                <option value="<?php echo $nama_wisata1?>"><?php echo $nama_wisata1?></option>
                <?php while($data = mysqli_fetch_assoc($result) ){?>
                  <option value="<?php echo $data['nama_wisata']; ?>"><?php echo $data['nama_wisata']; ?></option>
                <?php } ?>
              </select>
            </div>
            <label>Gambar Wisata 1 :</label><br>
            <a href="../../file_upload/<?php echo $gambar_wisata1?>"><img src="../../file_upload/<?php echo $gambar_wisata1?>" width="200px"></a><br><br>
            <label>Edit Gambar Wisata 1 :</label><br>
            <div class="row">
              <?php
              include '../../koneksi.php';
              $no=0;
              $result = mysqli_query($conn, "SELECT * FROM wisata ORDER BY id ASC");
              while($row = mysqli_fetch_assoc($result)) {
                $no++
                ?>
                <div class="col-md-4 mb-3">
                  <input type="radio" name="gambar_wisata1" value="<?php echo $row['gambar_wisata'];?>"><?php echo $row['nama_wisata']; ?>
                  <img class="card-img-top" src="../../file_upload/<?php echo $row['gambar_wisata'];?>" width="200" height="200">
                </div>
              <?php } ?>
            </div>
            <!-- /.row -->
            ...
            <div class="form-group">
              ...
              <select class="form-control" id="nama_wisata2" name="nama_wisata2" required="nama_wisata2">
                <option value="<?php echo $nama_wisata2?>"><?php echo $nama_wisata2?></option>
                <?php while($data = mysqli_fetch_assoc($result) ){?>
                  <option value="<?php echo $data['nama_wisata']; ?>"><?php echo $data['nama_wisata']; ?></option>
                <?php } ?>
              </select>
            </div>
            <label>Gambar Wisata 2 :</label><br>
            <a href="../../file_upload/<?php echo $gambar_wisata2?>"><img src="../../file_upload/<?php echo $gambar_wisata2?>" width="200px"></a><br><br>
            <label>Edit Gambar Wisata 2 :</label><br>
            <div class="row">
              <?php
              include '../../koneksi.php';
              $no=0;
              ...
              while($row = mysqli_fetch_assoc($result)) {
                ...
                ?>
                <div class="col-md-4 mb-3">
                  <input type="radio" name="gambar_wisata2" value="<?php echo $row['gambar_wisata'];?>"> <?php echo $row['nama_wisata']; ?>
                  <img class="card-img-top" src="../../file_upload/<?php echo $row['gambar_wisata'];?>" width="200" height="200">
                </div>
              <?php } ?>
            </div>
            ...
            <div class="form-group">
              ...
              <select class="form-control" id="nama_hotel" name="nama_hotel" required="nama_hotel">
                <option value="<?php echo $nama_hotel?>"><?php echo $nama_hotel?></option>
                <?php while($data = mysqli_fetch_assoc($result) ){?>
                  <option value="<?php echo $data['nama_hotel']; ?>"><?php echo $data['nama_hotel']; ?></option>
                <?php } ?>
              </select>
            </div>
            ...
            <label>Edit Gambar Hotel :</label><br>
            <div class="row">
              <?php
              include '../../koneksi.php';
              $no=0;
              $result = mysqli_query($conn, "SELECT * FROM hotel ORDER BY id ASC");
              while($row = mysqli_fetch_assoc($result)) {
                $no++
                ?>
                <div class="col-md-4 mb-3">
                  <input type="radio" name="gambar_hotel" value="<?php echo $row['gambar_hotel'];?>"> <?php echo $row['nama_hotel']; ?>
                  <img class="card-img-top" src="../../file_upload/<?php echo $row['gambar_hotel'];?>" width="200" height="200">
                </div>
              <?php } ?>
            </div>
            <!-- /.row -->
            ...
            $query = "SELECT * FROM restoran ORDER BY id ASC";
            ...
            <div class="form-group">
              ...
              <select class="form-control" id="nama_restoran" name="nama_restoran" required="nama_restoran">
                <option value="<?php echo $nama_restoran?>"><?php echo $nama_restoran?></option>
                <?php while($data = mysqli_fetch_assoc($result) ){?>
                  <option value="<?php echo $data['nama_restoran']; ?>"><?php echo $data['nama_restoran']; ?></option>
                <?php } ?>
              </select>
            </div>
            ...
            <label>Edit Gambar Restoran :</label><br>
            <div class="row">
              <?php
              include '../../koneksi.php';
              $no=0;
              $result = mysqli_query($conn, "SELECT * FROM restoran ORDER BY id ASC");
              while($row = mysqli_fetch_assoc($result)) {
                $no++
                ?>
                <div class="col-md-4 mb-3">
                  <input type="radio" name="gambar_restoran" value="<?php echo $row['gambar_restoran'];?>"> <?php echo $row['nama_restoran']; ?>
                  <img class="card-img-top" src="../../file_upload/<?php echo $row['gambar_restoran'];?>" width="200" height="200">
                </div>
              <?php } ?>
            </div>
            <!-- /.row -->
            ...
            <div class="form-group">
              ...
              <select class="form-control" id="nama_kendaraan" name="nama_kendaraan" required="nama_kendaraan">
                <option value="<?php echo $nama_kendaraan?>"><?php echo $nama_kendaraan?></option>
                <?php while($data = mysqli_fetch_assoc($result) ){?>
                  <option value="<?php echo $data['nama_kendaraan']; ?>"><?php echo $data['nama_kendaraan']; ?></option>
                <?php } ?>
              </select>
            </div>
            ...
            <label>Edit Gambar Kendaraan :</label><br>
            <div class="row">
              <?php
              include '../../koneksi.php';
              $no=0;
              $result = mysqli_query($conn, "SELECT * FROM kendaraan ORDER BY id ASC");
              while($row = mysqli_fetch_assoc($result)) {
                $no++
                ?>
                <div class="col-md-4 mb-3">
                  <input type="radio" name="gambar_kendaraan" value="<?php echo $row['gambar_kendaraan'];?>"> <?php echo $row['nama_kendaraan']; ?>
                  <img class="card-img-top" src="../../file_upload/<?php echo $row['gambar_kendaraan'];?>" width="200" height="200">
                </div>
              <?php } ?>
            </div>
            <!-- /.row -->
            ...
            <div class="form-group">
              ...
              <textarea type="text" class="form-control" id="keterangan" name="keterangan" required="keterangan"><?php echo $keterangan?></textarea>
            </div>
            <div class="form-group">
              <label for="harga">Harga :</label>
              <input type="number" class="form-control" id="harga" name="harga" required="harga" value="<?php echo $harga?>">
            </div>
...
{ 
 ...
 mysqli_query($conn, "UPDATE paket SET nama_paket='$nama_paket',nama_wisata1='$nama_wisata1',gambar_wisata1='$gambar_wisata1',nama_wisata2='$nama_wisata2',gambar_wisata2='$gambar_wisata2',nama_hotel='$nama_hotel',gambar_hotel='$gambar_hotel',nama_restoran='$nama_restoran',gambar_restoran='$gambar_restoran',nama_kendaraan='$nama_kendaraan',gambar_kendaraan='$gambar_kendaraan',keterangan='$keterangan',harga='$harga' WHERE id=$id");
