        ...
        <li class="nav-item">
          ...
          <li class="nav-item active">
            ...
            <div id="collapseFive" class="collapse" aria-labelledby="headingOnne" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Pilihan :</h6>
                <a class="collapse-item active" href="../data-hotel/index.php">Input Data</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 class="h3 mb-0 text-gray-800"><strong>INPUT DATA HOTEL</strong></h1>
            </div>
            <form action="" method="post" enctype="multipart/form-data">
              <div class="form-group">
                <label for="nama_hotel">Nama Hotel :</label>
                <input type="text" class="form-control" id="nama_hotel" placeholder="Enter Nama Hotel" name="nama_hotel" required="nama_hotel">
              </div>
              <div class="form-group">
                <label for="gambar_hotel">Foto Hotel :</label>
                <input type="file" class="form-control" id="gambar_hotel" placeholder="Enter Foto Hotel" name="gambar_hotel" required="gambar_hotel" >
...
if(isset($_POST['insert'])){
  ...
  $namaSementara = $_FILES['gambar_hotel']['tmp_name'];

    // tentukan lokasi gambar_hotel akan dipindahkan
  $dirUpload = "../../file_upload/";

    // pindahkan gambar_hotel
  $terupload = move_uploaded_file($namaSementara, $dirUpload.$gambar_hotel);

  $idakun = $_POST['idakun'];

    // Insert user data into table
  $result = mysqli_query($conn, "INSERT INTO hotel(nama_hotel,gambar_hotel) VALUES('$nama_hotel','".$gambar_hotel."')");
