...
$result = mysqli_query($conn, "SELECT * FROM hotel WHERE id=$id");
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 class="h3 mb-0 text-gray-800"><strong>EDIT DATA HOTEL</strong></h1>
            </div>

            <form action="" method="post" enctype="multipart/form-data">
              <div class="form-group">
                <label for="nama_hotel">Nama Hotel :</label>
                <input type="text" class="form-control" id="nama_hotel" placeholder="Enter Nama Hotel" name="nama_hotel" required="nama_hotel" value="<?php echo $nama_hotel ?>">
              </div>

              <div class="form-group">
                <label>Foto Hotel :</label><br>
                <a href="../../file_upload/<?php echo $gambar_hotel?>"><img src="../../file_upload/<?php echo $gambar_hotel?>" width="300px"></a><br><br>
                <input class="form-control" type="file" name="gambar_hotel">
              </div>
...
{   
  ...
  if(file_exists($_FILES['gambar_hotel']['tmp_name'])){
    $gambar_hotel = date("YmdHis").$_FILES['gambar_hotel']['name'];
    $namaid_cardSementara = $_FILES['gambar_hotel']['tmp_name'];
    $dirUpload = "../../file_upload/";
    $terupload = move_uploaded_file($namaid_cardSementara, $dirUpload.$gambar_hotel);
    mysqli_query($conn, "UPDATE hotel SET gambar_hotel='$gambar_hotel' WHERE id=$id");
  }

  mysqli_query($conn, "UPDATE hotel SET nama_hotel='$nama_hotel',gambar_hotel='$gambar_hotel' WHERE id=$id");
