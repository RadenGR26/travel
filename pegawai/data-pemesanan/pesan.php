          ...
          <li class="nav-item active">
            ...
            <div id="collapseOne" class="collapse" aria-labelledby="headingOnne" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item active" href="#">Pesan Paket Wisata</a>
              </div>
            </div>
          </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 class="h3 mb-0 text-gray-800"><strong>PESAN PAKET WISATA</strong></h1>
            </div>

            <form action="" method="post" enctype="multipart/form-data">
             <div class="form-group">
              <label for="username">Nama Pemesan :</label>
              <input type="text" class="form-control" id="username" placeholder="Enter Nama Pemesan" name="username" required="username" value="<?php
              if (isset($_SESSION['username'])) {
                echo $_SESSION['username'];
                }else{
                }
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" id="tiket" name="tiket" required="tiket" onkeyup="sum();">
              </div>
              <div class="form-group">
                <label for="total">total Harga :</label>
                <input type="number" class="form-control" id="total" name="total" required="total" readonly onkeyup="sum();">
              </div>
              <div class="form-group">
                <label for="tanggal_in">Mulai Tanggal :</label>
                <input type="date" class="form-control" id="tanggal_in" name="tanggal_in" required="tanggal_in" value="<?php echo $tanggal_in?>">
              </div>
              <div class="form-group">
                <label for="tanggal_out">Selesai Tanggal :</label>
                <input type="date" class="form-control" id="tanggal_out" name="tanggal_out" required="tanggal_out" value="<?php echo $tanggal_out?>">
              </div>
              <div class="form-group">
                <label>Status :</label>
                <select class="form-control" name="status" id="status" required readonly>
                  <option value="Mengajukan Pemesanan">Mengajukan Pemesanan</option>
                </select>
              </div>
              <button type="submit" name="insert" class="btn btn-primary">PESAN</button>
            </form>
          </div>
          <!-- /.container-fluid -->
...
if(isset($_POST['insert'])){
  ...
  $result = mysqli_query($conn, "INSERT INTO pemesanan(username,nama_paket,nama_wisata1,gambar_wisata1,nama_wisata2,gambar_wisata2,nama_hotel,gambar_hotel,nama_restoran,gambar_restoran,nama_kendaraan,gambar_kendaraan,keterangan,harga,tiket,total,tanggal_in,tanggal_out,status) VALUES('$username','$nama_paket','$nama_wisata1','$gambar_wisata1','$nama_wisata2','$gambar_wisata2','$nama_hotel','$gambar_hotel','$nama_restoran','$gambar_restoran','$nama_kendaraan','$gambar_kendaraan','$keterangan','$harga','$tiket','$total','$tanggal_in','$tanggal_out','$status')");
