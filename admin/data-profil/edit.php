        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 class="h3 mb-0 text-gray-800"><strong>EDIT DATA PROFIL</strong></h1>
            </div>

            <form action="" method="post" enctype="multipart/form-data">
             <div class="form-group">
              <label>Gambar :</label><br>
              <a href="../../file_upload/<?php echo $gambar?>"><img src="../../file_upload/<?php echo $gambar?>" width="300px"></a><br><br>
              <input class="form-control" type="file" name="gambar">
            </div>
            <div class="form-group">
              <label for="judul">Judul :</label>
              <input type="text" class="form-control" id="judul" placeholder="Enter Judul" name="judul" required="judul" value="<?php echo $judul ?>">
            </div>
             <div class="form-group">
              <label for="keterangan">Keterangan :</label>
              <textarea type="text" class="form-control" id="keterangan" placeholder="Enter Keterangan" name="keterangan" required="keterangan"><?php echo $keterangan ?></textarea>
            </div>
...
{   
  ...
  if(file_exists($_FILES['gambar']['tmp_name'])){
    ...
    $namaid_cardSementara = $_FILES['gambar']['tmp_name'];
    $dirUpload = "../../file_upload/";
    $terupload = move_uploaded_file($namaid_cardSementara, $dirUpload.$gambar);
    mysqli_query($conn, "UPDATE profil SET gambar='$gambar' WHERE id=$id");
  }

  $judul = $_POST['judul'];
  $keterangan = $_POST['keterangan'];

  mysqli_query($conn, "UPDATE profil SET gambar='$gambar',judul='$judul',keterangan='$keterangan' WHERE id=$id");
