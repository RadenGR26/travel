        ...
        <li class="nav-item">
          ...
          <li class="nav-item active">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingOnne" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Pilihan :</h6>
                <a class="collapse-item active" href="../data-profil/index.php">Input Data</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 class="h3 mb-0 text-gray-800"><strong>INPUT DATA PROFIL</strong></h1>
            </div>
            <form action="" method="post" enctype="multipart/form-data">
              <div class="form-group">
                <label for="gambar">Gambar :</label>
                <input type="file" class="form-control" id="gambar" placeholder="Enter Gambar" name="gambar" required="gambar" >
                <p style="color: red">Ekstensi yang diperbolehkan .png | .jpg | .jpeg &ensp; Size Max 2 MB</p>
              </div>
              <div class="form-group">
                <label for="judul">Judul :</label>
                <input type="text" class="form-control" id="judul" placeholder="Enter Judul" name="judul" required="judul">
              </div>
               <div class="form-group">
                <label for="keterangan">Keterangan :</label>
                <textarea type="text" class="form-control" id="keterangan" placeholder="Enter Keterangan" name="keterangan" required="keterangan"></textarea>
              </div>
...
if(isset($_POST['insert'])){
  ...
  $namaSementara = $_FILES['gambar']['tmp_name'];
    ...
    // tentukan lokasi gambar akan dipindahkan
  ...
  $result = mysqli_query($conn, "INSERT INTO profil(gambar,judul,keterangan) VALUES('".$gambar."','$judul','$keterangan')");
