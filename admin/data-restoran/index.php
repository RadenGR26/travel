        ...
        <li class="nav-item">
          ...
          <li class="nav-item active">
            ...
            <div id="collapse5" class="collapse" aria-labelledby="headingOnne" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Pilihan :</h6>
                <a class="collapse-item active" href="../data-restoran/index.php">Input Data</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 class="h3 mb-0 text-gray-800"><strong>INPUT DATA RESTORAN</strong></h1>
            </div>
            <form action="" method="post" enctype="multipart/form-data">
              <div class="form-group">
                <label for="nama_restoran">Nama Restoran :</label>
                <input type="text" class="form-control" id="nama_restoran" placeholder="Enter Nama Restoran" name="nama_restoran" required="nama_restoran">
              </div>
              <div class="form-group">
                <label for="gambar_restoran">Foto Restoran :</label>
                <input type="file" class="form-control" id="gambar_restoran" placeholder="Enter Foto Restoran" name="gambar_restoran" required="gambar_restoran" >
...
if(isset($_POST['insert'])){
  ...
  $namaSementara = $_FILES['gambar_restoran']['tmp_name'];

    // tentukan lokasi gambar_restoran akan dipindahkan
  $dirUpload = "../../file_upload/";

    // pindahkan gambar_restoran
  $terupload = move_uploaded_file($namaSementara, $dirUpload.$gambar_restoran);

  $idakun = $_POST['idakun'];

    // Insert user data into table
  $result = mysqli_query($conn, "INSERT INTO restoran(nama_restoran,gambar_restoran) VALUES('$nama_restoran','".$gambar_restoran."')");
