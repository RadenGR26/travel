        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 class="h3 mb-0 text-gray-800"><strong>EDIT DATA RESTORAN</strong></h1>
            </div>

            <form action="" method="post" enctype="multipart/form-data">
              <div class="form-group">
                <label for="nama_restoran">Nama Restoran :</label>
                <input type="text" class="form-control" id="nama_restoran" placeholder="Enter Nama Restoran" name="nama_restoran" required="nama_restoran" value="<?php echo $nama_restoran ?>">
              </div>

              <div class="form-group">
                <label>Foto Restoran :</label><br>
                <a href="../../file_upload/<?php echo $gambar_restoran?>"><img src="../../file_upload/<?php echo $gambar_restoran?>" width="300px"></a><br><br>
                <input class="form-control" type="file" name="gambar_restoran">
              </div>
...
{   
  ...
  if(file_exists($_FILES['gambar_restoran']['tmp_name'])){
    $gambar_restoran = date("YmdHis").$_FILES['gambar_restoran']['name'];
    $namaid_cardSementara = $_FILES['gambar_restoran']['tmp_name'];
    $dirUpload = "../../file_upload/";
    $terupload = move_uploaded_file($namaid_cardSementara, $dirUpload.$gambar_restoran);
    mysqli_query($conn, "UPDATE restoran SET gambar_restoran='$gambar_restoran' WHERE id=$id");
  }

  mysqli_query($conn, "UPDATE restoran SET nama_restoran='$nama_restoran',gambar_restoran='$gambar_restoran' WHERE id=$id");
