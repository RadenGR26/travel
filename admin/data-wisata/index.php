        ...
        <li class="nav-item">
          ...
          <li class="nav-item active">
            ...
            <div id="collapseFour" class="collapse" aria-labelledby="headingOnne" data-parent="#accordionSidebar">
              <div class="bg-white py-2 collapse-inner rounded">
                <h6 class="collapse-header">Pilihan :</h6>
                <a class="collapse-item active" href="../data-wisata/index.php">Input Data</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
              <h1 class="h3 mb-0 text-gray-800"><strong>INPUT DATA WISATA</strong></h1>
            </div>
            <form action="" method="post" enctype="multipart/form-data">
              <div class="form-group">
                <label for="nama_wisata">Nama Wisata :</label>
                <input type="text" class="form-control" id="nama_wisata" placeholder="Enter Nama Wisata" name="nama_wisata" required="nama_wisata">
              </div>
              <div class="form-group">
                <label for="gambar_wisata">Foto Wisata :</label>
                <input type="file" class="form-control" id="gambar_wisata" placeholder="Enter Foto Wisata" name="gambar_wisata" required="gambar_wisata" >
...
if(isset($_POST['insert'])){
  ...
  $namaSementara = $_FILES['gambar_wisata']['tmp_name'];
    ...
    // tentukan lokasi gambar_wisata akan dipindahkan
  $dirUpload = "../../file_upload/";

    // pindahkan gambar_wisata
  $terupload = move_uploaded_file($namaSementara, $dirUpload.$gambar_wisata);

  $idakun = $_POST['idakun'];

    // Insert user data into table
  $result = mysqli_query($conn, "INSERT INTO wisata(nama_wisata,gambar_wisata) VALUES('$nama_wisata','".$gambar_wisata."')");
